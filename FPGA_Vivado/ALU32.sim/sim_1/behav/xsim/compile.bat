...
REM
REM Generated by Vivado on Sat Jun 27 22:31:13 +0530 2026
...
echo "xvlog --incr --relax -prj tb_arithmetic_unit_vlog.prj"
call xvlog  --incr --relax -prj tb_arithmetic_unit_vlog.prj -log xvlog.log

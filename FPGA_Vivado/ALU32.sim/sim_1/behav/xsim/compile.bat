...
REM
REM Generated by Vivado on Sun Jun 28 06:56:26 +0530 2026
...
echo "xvlog --incr --relax -prj tb_logical_unit_vlog.prj"
call xvlog  --incr --relax -prj tb_logical_unit_vlog.prj -log xvlog.log

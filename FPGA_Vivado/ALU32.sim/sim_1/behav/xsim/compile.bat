...
REM
REM Generated by Vivado on Sun Jun 28 07:11:55 +0530 2026
...
echo "xvlog --incr --relax -prj tb_shift_unit_vlog.prj"
call xvlog  --incr --relax -prj tb_shift_unit_vlog.prj -log xvlog.log

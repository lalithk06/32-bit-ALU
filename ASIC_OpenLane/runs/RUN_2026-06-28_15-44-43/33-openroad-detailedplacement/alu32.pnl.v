module alu32 (C,
 ...
 sky130_fd_sc_hd__inv_2 _1016_ (.A(net186),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0058_));
 sky130_fd_sc_hd__inv_2 _1017_ (.A(net184),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _1022_ (.A(net238),
    ...
    .VPWR(VPWR),
    .Y(_0121_));
 sky130_fd_sc_hd__inv_2 _1023_ (.A(net208),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _1034_ (.A(net183),
    ...
    .VPWR(VPWR),
    .Y(_0167_));
 sky130_fd_sc_hd__inv_2 _1035_ (.A(net195),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _1046_ (.A(net38),
    ...
    .VPWR(VPWR),
    .Y(_0179_));
 sky130_fd_sc_hd__nor2_2 _1047_ (.A(net186),
    .B(net184),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _1049_ (.A(_0058_),
    ...
    .VPWR(VPWR),
    .Y(_0182_));
 sky130_fd_sc_hd__nand2_2 _1050_ (.A(net186),
    .B(net185),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0183_));
 sky130_fd_sc_hd__a21bo_1 _1051_ (.A1(net186),
    .A2(net185),
    .B1_N(net65),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or4_1 _1055_ (.A(net65),
    ...
    .VPWR(VPWR),
    .X(_0188_));
 sky130_fd_sc_hd__nor2_1 _1056_ (.A(net166),
    .B(net158),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _1060_ (.A(net188),
    ...
    .VPWR(VPWR),
    .X(_0193_));
 sky130_fd_sc_hd__o2bb2a_1 _1061_ (.A1_N(net186),
    .A2_N(net185),
    .B1(net65),
    .B2(net66),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__a21boi_1 _1062_ (.A1(net186),
    .A2(net185),
    .B1_N(net188),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _1063_ (.A(_0194_),
    ...
    .VPWR(VPWR),
    .Y(_0196_));
 sky130_fd_sc_hd__or2_1 _1064_ (.A(_0194_),
    .B(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a221o_1 _1077_ (.A1(net216),
    ...
    .VPWR(VPWR),
    .X(_0210_));
 sky130_fd_sc_hd__mux2_1 _1078_ (.A0(net8),
    .A1(net9),
    .S(net220),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o31a_1 _1114_ (.A1(net192),
    ...
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__nor2_4 _1115_ (.A(net186),
    .B(_0068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _1116_ (.A(_0058_),
    ...
    .VPWR(VPWR),
    .Y(_0249_));
 sky130_fd_sc_hd__a21o_1 _1117_ (.A1(net117),
    .A2(net146),
    .B1(_0249_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _1123_ (.A1(net1),
    ...
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__or4b_1 _1124_ (.A(net65),
    .B(_0178_),
    .C(net170),
    .D_N(net187),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1135_ (.A(net153),
    ...
    .VPWR(VPWR),
    .Y(_0267_));
 sky130_fd_sc_hd__o21a_1 _1136_ (.A1(net250),
    .A2(_0266_),
    .B1(net153),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1159_ (.A(net224),
    ...
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__nor3_1 _1160_ (.A(net158),
    .B(_0285_),
    .C(_0291_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_2 _1181_ (.A(_0278_),
    ...
    .VPWR(VPWR),
    .Y(net84));
 sky130_fd_sc_hd__a2bb2o_1 _1182_ (.A1_N(_0100_),
    .A2_N(_0267_),
    .B1(_0268_),
    .B2(_0264_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _1191_ (.A0(_0212_),
    ...
    .VPWR(VPWR),
    .X(_0322_));
 sky130_fd_sc_hd__mux4_1 _1192_ (.A0(net247),
    .A1(net246),
    .A2(net245),
    .A3(net244),
    .S0(net221),
 ...
 sky130_fd_sc_hd__mux2_1 _1193_ (.A0(_0322_),
    ...
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__and2_1 _1194_ (.A(net175),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _1195_ (.A(net214),
    ...
    .VPWR(VPWR),
    .Y(_0326_));
 sky130_fd_sc_hd__mux4_1 _1196_ (.A0(net243),
    .A1(net241),
    .A2(net240),
    .A3(net239),
    .S0(net223),
 ...
 sky130_fd_sc_hd__o211a_1 _1207_ (.A1(net180),
    ...
    .VPWR(VPWR),
    .X(_0338_));
 sky130_fd_sc_hd__a221o_1 _1208_ (.A1(net195),
    .A2(_0335_),
    .B1(_0336_),
    .B2(_0240_),
    .C1(_0338_),
 ...
 sky130_fd_sc_hd__a31o_1 _1224_ (.A1(_0351_),
    ...
    .VPWR(VPWR),
    .X(_0355_));
 sky130_fd_sc_hd__or3b_4 _1225_ (.A(_0321_),
    .B(_0348_),
    .C_N(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__a2bb2o_1 _1226_ (.A1_N(_0121_),
    .A2_N(_0316_),
    .B1(_0317_),
    .B2(_0313_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _1230_ (.A(net193),
    ...
    .VPWR(VPWR),
    .Y(_0360_));
 sky130_fd_sc_hd__or3_1 _1231_ (.A(net143),
    .B(_0358_),
    .C(_0360_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _1244_ (.A0(_0372_),
    ...
    .VPWR(VPWR),
    .X(_0374_));
 sky130_fd_sc_hd__o32a_1 _1245_ (.A1(net202),
    .A2(net120),
    .A3(_0372_),
    .B1(_0374_),
    .B2(net165),
    ...
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__a21oi_1 _1246_ (.A1(_0370_),
    .A2(_0375_),
    .B1(net172),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1272_ (.A(_0401_),
    ...
    .VPWR(VPWR),
    .Y(net98));
 sky130_fd_sc_hd__a32o_1 _1273_ (.A1(net233),
    .A2(_0180_),
    .A3(_0361_),
    .B1(_0363_),
    .B2(_0356_),
    ...
    .VPWR(VPWR),
    .X(_0402_));
 sky130_fd_sc_hd__nor2_1 _1274_ (.A(net181),
    .B(net146),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _1304_ (.A(net169),
    ...
    .VPWR(VPWR),
    .Y(net99));
 sky130_fd_sc_hd__a21o_1 _1305_ (.A1(_0402_),
    .A2(_0407_),
    .B1(_0406_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _1336_ (.A1(_0460_),
    ...
    .VPWR(VPWR),
    .X(_0464_));
 sky130_fd_sc_hd__a31o_1 _1337_ (.A1(_0441_),
    .A2(_0456_),
    .A3(_0464_),
    .B1(net170),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1338_ (.A(_0465_),
    ...
    .VPWR(VPWR),
    .Y(net100));
 sky130_fd_sc_hd__a2bb2o_1 _1339_ (.A1_N(_0153_),
    .A2_N(_0436_),
    .B1(_0437_),
    .B2(_0433_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1371_ (.A(_0497_),
    ...
    .VPWR(VPWR),
    .Y(net101));
 sky130_fd_sc_hd__a2bb2o_1 _1372_ (.A1_N(_0159_),
    .A2_N(_0469_),
    .B1(_0470_),
    .B2(_0466_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _1402_ (.A(net169),
    ...
    .VPWR(VPWR),
    .Y(net102));
 sky130_fd_sc_hd__a2bb2o_1 _1403_ (.A1_N(_0160_),
    .A2_N(_0501_),
    .B1(_0502_),
    .B2(_0498_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _1426_ (.A1(_0225_),
    ...
    .VPWR(VPWR),
    .X(_0551_));
 sky130_fd_sc_hd__a221o_1 _1427_ (.A1(net186),
    .A2(_0542_),
    .B1(_0551_),
    .B2(net185),
    .C1(_0536_),
 ...
 sky130_fd_sc_hd__inv_2 _1429_ (.A(_0553_),
    ...
    .VPWR(VPWR),
    .Y(net103));
 sky130_fd_sc_hd__a2bb2o_1 _1430_ (.A1_N(_0161_),
    .A2_N(_0531_),
    .B1(_0532_),
    .B2(_0528_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1455_ (.A(_0248_),
    ...
    .VPWR(VPWR),
    .Y(_0579_));
 sky130_fd_sc_hd__o211a_1 _1456_ (.A1(_0058_),
    .A2(_0569_),
    .B1(_0579_),
    .C1(_0563_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0580_));
 sky130_fd_sc_hd__nor2_1 _1457_ (.A(net169),
    .B(_0580_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net104));
 sky130_fd_sc_hd__a21o_1 _1458_ (.A1(_0554_),
    .A2(_0557_),
    .B1(_0558_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _1464_ (.A(_0584_),
    ...
    .VPWR(VPWR),
    .X(_0587_));
 sky130_fd_sc_hd__xnor2_1 _1465_ (.A(_0581_),
    .B(_0587_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _1466_ (.A1_N(net34),
    ...
    .VPWR(VPWR),
    .X(_0589_));
 sky130_fd_sc_hd__nand2_1 _1467_ (.A(_0588_),
    .B(_0589_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a221o_1 _1483_ (.A1(net113),
    ...
    .VPWR(VPWR),
    .X(_0606_));
 sky130_fd_sc_hd__a221o_1 _1484_ (.A1(net124),
    .A2(_0590_),
    .B1(_0606_),
    .B2(net184),
    .C1(_0597_),
    ...
    .VPWR(VPWR),
    .X(_0607_));
 sky130_fd_sc_hd__nand2_1 _1485_ (.A(_0183_),
    .B(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _1486_ (.A(_0608_),
    ...
    .VPWR(VPWR),
    .Y(net74));
 sky130_fd_sc_hd__a21o_1 _1487_ (.A1(_0581_),
    .A2(_0584_),
    .B1(_0585_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1492_ (.A1(_0164_),
    ...
    .VPWR(VPWR),
    .Y(_0614_));
 sky130_fd_sc_hd__xor2_1 _1493_ (.A(_0609_),
    .B(_0614_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _1494_ (.A1_N(net35),
    ...
    .VPWR(VPWR),
    .X(_0616_));
 sky130_fd_sc_hd__a21o_1 _1495_ (.A1(_0615_),
    .A2(_0616_),
    .B1(net122),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _1511_ (.A1(net192),
    ...
    .VPWR(VPWR),
    .Y(_0633_));
 sky130_fd_sc_hd__o221a_1 _1512_ (.A1(_0058_),
    .A2(_0623_),
    .B1(_0633_),
    .B2(_0249_),
    .C1(_0617_),
    ...
    .VPWR(VPWR),
    .X(_0634_));
 sky130_fd_sc_hd__nor2_1 _1513_ (.A(net169),
    .B(_0634_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net75));
 sky130_fd_sc_hd__a2bb2o_1 _1514_ (.A1_N(_0164_),
    .A2_N(_0612_),
    .B1(_0613_),
    .B2(_0609_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22oi_1 _1521_ (.A1(net36),
    ...
    .VPWR(VPWR),
    .Y(_0642_));
 sky130_fd_sc_hd__a21o_1 _1522_ (.A1(_0641_),
    .A2(_0642_),
    .B1(net122),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _1538_ (.A1(net192),
    ...
    .VPWR(VPWR),
    .Y(_0659_));
 sky130_fd_sc_hd__o211a_1 _1539_ (.A1(_0249_),
    .A2(_0659_),
    .B1(_0651_),
    .C1(_0643_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1540_ (.A(_0660_),
    ...
    .VPWR(VPWR),
    .Y(net76));
 sky130_fd_sc_hd__a21o_1 _1541_ (.A1(_0635_),
    .A2(_0640_),
    .B1(_0639_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1546_ (.A1(_0165_),
    ...
    .VPWR(VPWR),
    .Y(_0666_));
 sky130_fd_sc_hd__xor2_1 _1547_ (.A(_0661_),
    .B(_0666_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _1559_ (.A1(net173),
    ...
    .VPWR(VPWR),
    .Y(_0679_));
 sky130_fd_sc_hd__or4b_1 _1560_ (.A(net117),
    .B(_0679_),
    .C(net171),
    .D_N(_0287_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _1568_ (.A1(_0249_),
    ...
    .VPWR(VPWR),
    .X(_0688_));
 sky130_fd_sc_hd__nor2_1 _1569_ (.A(net169),
    .B(_0688_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net77));
 sky130_fd_sc_hd__a2bb2o_1 _1570_ (.A1_N(_0165_),
    .A2_N(_0664_),
    .B1(_0665_),
    .B2(_0661_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _1575_ (.A(_0692_),
    ...
    .VPWR(VPWR),
    .Y(_0694_));
 sky130_fd_sc_hd__xnor2_1 _1576_ (.A(_0689_),
    .B(_0694_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _1594_ (.A1(_0708_),
    ...
    .VPWR(VPWR),
    .X(_0713_));
 sky130_fd_sc_hd__o211a_1 _1595_ (.A1(net122),
    .A2(_0696_),
    .B1(_0704_),
    .C1(_0713_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1596_ (.A(_0714_),
    ...
    .VPWR(VPWR),
    .Y(net78));
 sky130_fd_sc_hd__a21o_1 _1597_ (.A1(_0689_),
    .A2(_0694_),
    .B1(_0693_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1602_ (.A1(_0167_),
    ...
    .VPWR(VPWR),
    .Y(_0720_));
 sky130_fd_sc_hd__xor2_1 _1603_ (.A(_0715_),
    .B(_0720_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _1622_ (.A1(net107),
    ...
    .VPWR(VPWR),
    .Y(_0740_));
 sky130_fd_sc_hd__o211a_1 _1623_ (.A1(net125),
    .A2(_0731_),
    .B1(_0740_),
    .C1(_0723_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0741_));
 sky130_fd_sc_hd__nor2_1 _1624_ (.A(net169),
    .B(_0741_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net79));
 sky130_fd_sc_hd__a2bb2o_1 _1625_ (.A1_N(_0167_),
    .A2_N(_0718_),
    .B1(_0719_),
    .B2(_0715_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1630_ (.A1(_0169_),
    ...
    .VPWR(VPWR),
    .Y(_0747_));
 sky130_fd_sc_hd__xor2_1 _1631_ (.A(_0742_),
    .B(_0747_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _1632_ (.A1_N(net40),
    ...
    .VPWR(VPWR),
    .X(_0749_));
 sky130_fd_sc_hd__nand2_1 _1633_ (.A(_0748_),
    .B(_0749_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _1647_ (.A1(net195),
    ...
    .VPWR(VPWR),
    .X(_0764_));
 sky130_fd_sc_hd__a22oi_1 _1648_ (.A1(net124),
    .A2(_0750_),
    .B1(_0764_),
    .B2(net184),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0765_));
 sky130_fd_sc_hd__a21o_1 _1649_ (.A1(_0758_),
    .A2(_0765_),
    .B1(net170),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1650_ (.A(_0766_),
    ...
    .VPWR(VPWR),
    .Y(net80));
 sky130_fd_sc_hd__a2bb2o_1 _1651_ (.A1_N(_0169_),
    .A2_N(_0745_),
    .B1(_0746_),
    .B2(_0742_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _1657_ (.A(_0770_),
    ...
    .VPWR(VPWR),
    .X(_0773_));
 sky130_fd_sc_hd__xnor2_1 _1658_ (.A(_0767_),
    .B(_0773_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _1674_ (.A1(_0068_),
    ...
    .VPWR(VPWR),
    .X(_0790_));
 sky130_fd_sc_hd__or2_1 _1675_ (.A(net170),
    .B(_0790_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _1676_ (.A(_0791_),
    ...
    .VPWR(VPWR),
    .Y(net81));
 sky130_fd_sc_hd__a21o_1 _1677_ (.A1(_0767_),
    .A2(_0770_),
    .B1(_0771_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _1683_ (.A0(net252),
    ...
    .VPWR(VPWR),
    .X(_0798_));
 sky130_fd_sc_hd__xnor2_1 _1684_ (.A(_0792_),
    .B(_0798_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a2bb2o_1 _1698_ (.A1_N(_0812_),
    ...
    .VPWR(VPWR),
    .X(_0813_));
 sky130_fd_sc_hd__a21o_1 _1699_ (.A1(net124),
    .A2(_0800_),
    .B1(_0813_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__a32o_1 _1700_ (.A1(net252),
    .A2(_0180_),
    .A3(_0795_),
    .B1(_0797_),
    .B2(_0792_),
 ...
 sky130_fd_sc_hd__o21ai_1 _1705_ (.A1(_0171_),
    ...
    .VPWR(VPWR),
    .Y(_0819_));
 sky130_fd_sc_hd__xor2_1 _1706_ (.A(_0814_),
    .B(_0819_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _1707_ (.A1_N(net43),
    ...
    .VPWR(VPWR),
    .X(_0821_));
 sky130_fd_sc_hd__a21o_1 _1708_ (.A1(_0820_),
    .A2(_0821_),
    .B1(net123),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a31o_1 _1722_ (.A1(_0831_),
    ...
    .VPWR(VPWR),
    .X(_0836_));
 sky130_fd_sc_hd__and3_1 _1723_ (.A(_0822_),
    .B(_0829_),
    .C(_0836_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0837_));
 sky130_fd_sc_hd__nor2_1 _1724_ (.A(net170),
    .B(_0837_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net83));
 sky130_fd_sc_hd__a2bb2o_1 _1725_ (.A1_N(_0171_),
    .A2_N(_0817_),
    .B1(_0818_),
    .B2(_0814_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1730_ (.A1(_0172_),
    ...
    .VPWR(VPWR),
    .Y(_0843_));
 sky130_fd_sc_hd__xor2_1 _1731_ (.A(_0838_),
    .B(_0843_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _1732_ (.A1_N(net45),
    ...
    .VPWR(VPWR),
    .X(_0845_));
 sky130_fd_sc_hd__nand2_1 _1733_ (.A(_0844_),
    .B(_0845_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o311a_1 _1748_ (.A1(net182),
    ...
    .VPWR(VPWR),
    .X(_0861_));
 sky130_fd_sc_hd__a211o_1 _1749_ (.A1(net124),
    .A2(_0846_),
    .B1(_0854_),
    .C1(_0861_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__a2bb2o_1 _1750_ (.A1_N(_0172_),
    .A2_N(_0841_),
    .B1(_0842_),
    .B2(_0838_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _1755_ (.A(_0865_),
    ...
    .VPWR(VPWR),
    .Y(_0867_));
 sky130_fd_sc_hd__xnor2_1 _1756_ (.A(_0862_),
    .B(_0867_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_1 _1757_ (.A1(net46),
    ...
    .VPWR(VPWR),
    .Y(_0869_));
 sky130_fd_sc_hd__a21o_1 _1758_ (.A1(_0868_),
    .A2(_0869_),
    .B1(net123),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o311a_1 _1771_ (.A1(net248),
    ...
    .VPWR(VPWR),
    .X(_0883_));
 sky130_fd_sc_hd__o221a_1 _1772_ (.A1(_0068_),
    .A2(_0877_),
    .B1(_0883_),
    .B2(net126),
    .C1(_0870_),
    ...
    .VPWR(VPWR),
    .X(_0884_));
 sky130_fd_sc_hd__nor2_1 _1773_ (.A(net170),
    .B(_0884_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net86));
 sky130_fd_sc_hd__a21o_1 _1774_ (.A1(_0862_),
    .A2(_0867_),
    .B1(_0866_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _1781_ (.A1_N(net47),
    ...
    .VPWR(VPWR),
    .X(_0892_));
 sky130_fd_sc_hd__nand2_1 _1782_ (.A(_0891_),
    .B(_0892_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a32o_1 _1795_ (.A1(_0248_),
    ...
    .VPWR(VPWR),
    .X(_0906_));
 sky130_fd_sc_hd__o21bai_2 _1796_ (.A1(net125),
    .A2(_0905_),
    .B1_N(_0906_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net87));
 sky130_fd_sc_hd__a2bb2o_1 _1797_ (.A1_N(_0173_),
    .A2_N(_0888_),
    .B1(_0889_),
    .B2(_0885_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1822_ (.A1(_0922_),
    ...
    .VPWR(VPWR),
    .X(_0932_));
 sky130_fd_sc_hd__nor2_1 _1823_ (.A(net169),
    .B(_0932_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net88));
 sky130_fd_sc_hd__a2bb2o_1 _1824_ (.A1_N(_0174_),
    .A2_N(_0910_),
    .B1(_0911_),
    .B2(_0907_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _1830_ (.A(_0936_),
    ...
    .VPWR(VPWR),
    .X(_0939_));
 sky130_fd_sc_hd__xnor2_1 _1831_ (.A(_0933_),
    .B(_0939_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22oi_1 _1832_ (.A1(net49),
    ...
    .VPWR(VPWR),
    .Y(_0941_));
 sky130_fd_sc_hd__a21o_1 _1833_ (.A1(_0940_),
    .A2(_0941_),
    .B1(net123),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1846_ (.A(net184),
    ...
    .VPWR(VPWR),
    .Y(_0955_));
 sky130_fd_sc_hd__a31o_1 _1847_ (.A1(_0942_),
    .A2(_0948_),
    .A3(_0955_),
    .B1(net169),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1848_ (.A(_0956_),
    ...
    .VPWR(VPWR),
    .Y(net89));
 sky130_fd_sc_hd__a21o_1 _1849_ (.A1(_0933_),
    .A2(_0936_),
    .B1(_0937_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1854_ (.A1(_0175_),
    ...
    .VPWR(VPWR),
    .Y(_0962_));
 sky130_fd_sc_hd__xor2_1 _1855_ (.A(_0957_),
    .B(_0962_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _1856_ (.A1_N(net50),
    ...
    .VPWR(VPWR),
    .X(_0964_));
 sky130_fd_sc_hd__nand2_1 _1857_ (.A(_0963_),
    .B(_0964_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _1872_ (.A1(_0974_),
    ...
    .VPWR(VPWR),
    .X(_0980_));
 sky130_fd_sc_hd__a211o_1 _1873_ (.A1(net124),
    .A2(_0965_),
    .B1(_0973_),
    .C1(_0980_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0981_));
 sky130_fd_sc_hd__nand2_1 _1874_ (.A(_0183_),
    .B(_0981_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _1875_ (.A(_0982_),
    ...
    .VPWR(VPWR),
    .Y(net90));
 sky130_fd_sc_hd__a2bb2o_1 _1876_ (.A1_N(_0175_),
    .A2_N(_0960_),
    .B1(_0961_),
    .B2(_0957_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _1883_ (.A1_N(net51),
    ...
    .VPWR(VPWR),
    .X(_0990_));
 sky130_fd_sc_hd__nand2_1 _1884_ (.A(_0989_),
    .B(_0990_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _1899_ (.A1(_1004_),
    ...
    .VPWR(VPWR),
    .X(_1006_));
 sky130_fd_sc_hd__a221o_1 _1900_ (.A1(net124),
    .A2(_0991_),
    .B1(_0999_),
    .B2(net68),
    .C1(_1006_),
    ...
    .VPWR(VPWR),
    .X(_1007_));
 sky130_fd_sc_hd__and2_1 _1901_ (.A(_0183_),
    .B(_1007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__a2bb2o_1 _1902_ (.A1_N(_0176_),
    .A2_N(_0986_),
    .B1(_0987_),
    .B2(_0983_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31a_1 _1922_ (.A1(_0548_),
    ...
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__a2bb2o_1 _1923_ (.A1_N(net125),
    .A2_N(_0006_),
    .B1(net124),
    .B2(_0000_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__nor2_1 _1924_ (.A(_0012_),
    .B(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0014_));
 sky130_fd_sc_hd__nor2_1 _1925_ (.A(net170),
    .B(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net92));
 sky130_fd_sc_hd__a2bb2o_1 _1926_ (.A1_N(_0177_),
    .A2_N(_1011_),
    .B1(_1012_),
    .B2(_1008_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1948_ (.A1(_0035_),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__a211o_1 _1949_ (.A1(net124),
    .A2(_0024_),
    .B1(_0031_),
    .C1(_0037_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__a21o_1 _1950_ (.A1(_0015_),
    .A2(_0018_),
    .B1(_0020_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _1958_ (.A1(net54),
    ...
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__o21ai_1 _1959_ (.A1(_0045_),
    .A2(_0046_),
    .B1(_0410_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _1971_ (.A1(net112),
    ...
    .VPWR(VPWR),
    .Y(_0060_));
 sky130_fd_sc_hd__o221a_1 _1972_ (.A1(net125),
    .A2(_0053_),
    .B1(_0060_),
    .B2(_0068_),
    .C1(_0047_),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__nor2_1 _1973_ (.A(net169),
    .B(_0061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net94));
 sky130_fd_sc_hd__a21o_1 _1974_ (.A1(_0038_),
    .A2(_0041_),
    .B1(_0042_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _1994_ (.A1(net114),
    ...
    .VPWR(VPWR),
    .Y(_0084_));
 sky130_fd_sc_hd__o2bb2a_1 _1995_ (.A1_N(net124),
    .A2_N(_0070_),
    .B1(_0084_),
    .B2(_0068_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _2002_ (.A(_0086_),
    ...
    .VPWR(VPWR),
    .Y(_0092_));
 sky130_fd_sc_hd__xor2_1 _2003_ (.A(_0086_),
    .B(_0091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _2018_ (.A(net96),
    ...
    .VPWR(VPWR),
    .Y(_0108_));
 sky130_fd_sc_hd__xnor2_1 _2019_ (.A(net96),
    .B(net71),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _2037_ (.A(net73),
    ...
    .VPWR(VPWR),
    .Y(_0129_));
 sky130_fd_sc_hd__xnor2_1 _2038_ (.A(net95),
    .B(_0401_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or4_1 _2061_ (.A(net82),
    ...
    .VPWR(VPWR),
    .X(_0155_));
 sky130_fd_sc_hd__or4_1 _2062_ (.A(net91),
    .B(net92),
    .C(_0113_),
    .D(_0155_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__nor4b_1 _2063_ (.A(net85),
    .B(_0156_),
    .C(net86),
    .D_N(_0115_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_2 input66 (.A(alu_opcode[1]),
    ...
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__clkbuf_1 input67 (.A(alu_opcode[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__clkbuf_2 input68 (.A(alu_opcode[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__clkbuf_1 input69 (.A(alu_opcode[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout108 (.A(_0260_),
    ...
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__clkbuf_4 fanout109 (.A(_0258_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout111 (.A(_0231_),
    ...
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__clkbuf_4 fanout112 (.A(_0403_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout114 (.A(_0295_),
    ...
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__buf_2 fanout115 (.A(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout116 (.A(_0257_),
    ...
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__clkbuf_4 fanout117 (.A(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout120 (.A(net121),
    ...
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__clkbuf_2 fanout121 (.A(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout145 (.A(_0199_),
    ...
    .VPWR(VPWR),
    .X(net145));
 sky130_fd_sc_hd__clkbuf_4 fanout146 (.A(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout157 (.A(_0192_),
    ...
    .VPWR(VPWR),
    .X(net157));
 sky130_fd_sc_hd__buf_2 fanout158 (.A(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout160 (.A(net161),
    ...
    .VPWR(VPWR),
    .X(net160));
 sky130_fd_sc_hd__buf_2 fanout161 (.A(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout167 (.A(net168),
    ...
    .VPWR(VPWR),
    .X(net167));
 sky130_fd_sc_hd__buf_1 wire168 (.A(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout169 (.A(net170),
    ...
    .VPWR(VPWR),
    .X(net169));
 sky130_fd_sc_hd__clkbuf_4 fanout170 (.A(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout176 (.A(net177),
    ...
    .VPWR(VPWR),
    .X(net176));
 sky130_fd_sc_hd__clkbuf_2 fanout177 (.A(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net177));
 sky130_fd_sc_hd__clkbuf_4 fanout178 (.A(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout179 (.A(_0132_),
    ...
    .VPWR(VPWR),
    .X(net179));
 sky130_fd_sc_hd__clkbuf_4 fanout180 (.A(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout184 (.A(net185),
    ...
    .VPWR(VPWR),
    .X(net184));
 sky130_fd_sc_hd__clkbuf_4 fanout185 (.A(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net185));
 sky130_fd_sc_hd__clkbuf_4 fanout186 (.A(net68),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout187 (.A(net188),
    ...
    .VPWR(VPWR),
    .X(net187));
 sky130_fd_sc_hd__clkbuf_2 fanout188 (.A(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout196 (.A(net197),
    ...
    .VPWR(VPWR),
    .X(net196));
 sky130_fd_sc_hd__buf_2 fanout197 (.A(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout213 (.A(net214),
    ...
    .VPWR(VPWR),
    .X(net213));
 sky130_fd_sc_hd__clkbuf_2 fanout214 (.A(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout219 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net219));
 sky130_fd_sc_hd__clkbuf_4 fanout220 (.A(net224),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout223 (.A(net224),
    ...
    .VPWR(VPWR),
    .X(net223));
 sky130_fd_sc_hd__buf_2 fanout224 (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
